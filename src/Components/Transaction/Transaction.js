                ...
                <Col xs="8" xl="12">
                  <Table responsive>
                    <tr>
                      ...
                      <th className="fainted-text">Customer</th>
                      <th className="fainted-text">Reference number</th>
                      ...
                      <th className="fainted-text">Time</th>
                    ...
                    <tbody>
                      <tr> 
                        ...
                        <td className="body-text">3364 789 6580</td>
                        ...
                        <td className="body-text"><Icon name="eye" size="small" /> <span className="transaction-status">Successful</span></td>
                      </tr>
                      <tr> 
                        <td className="fainted-text">001</td>
                        <td className="body-text">Paul Okeke</td>
